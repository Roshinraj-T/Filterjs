...
names=[{name:'roshin',hobbies:'playing'},
{name:'selva',hobbies:'game'},
{namae:'singaram',hobbies:'walking'},
{name:'ajith',hobbies:'playing'},
{name:'gokul',hobbies:'game'},
{namae:'rajiv',hobbies:'walking'}]
